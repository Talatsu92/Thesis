		...
		CountDownTimer timer = new CountDownTimer(5000, 1000){
			...
			public void onFinish() {
				if(monitor == null){
					...
					Log.v("VAR", "Accel: " + accelerometer + " Gyro: " + gyroscope);
					Log.v("VAR", "SensorManager: " + mSensorManager + " LocManager: " + locationManager);
					Log.v("VAR", "ConManager: " + connectivityManager);
					monitor = new Monitor(accelerometer, gyroscope, mSensorManager, locationManager, connectivityManager, MainMenu.this, context);
					Log.v(LOG, "Monitor() called");
				}
				ImageButton startButton = (ImageButton) findViewById(R.id.StartButton);
